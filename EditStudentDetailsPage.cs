...
{
    public partial class AdminEditStudentDetailsPage : Form
    {
        ...
        public AdminEditStudentDetailsPage(string studentNo)
        {
            InitializeComponent();
        ...
        private void btnBackToResults_Click_1(object sender, EventArgs e)
        {
            AdministratorDashboardPage administratorDashboardPage = new AdministratorDashboardPage();
            administratorDashboardPage.Show();
            this.Hide();
        ...
        private void txtFMTG_TextChanged(object sender, EventArgs e)
        {
        ...
        private void lblApplicantHeading_Click(object sender, EventArgs e)
        {
        ...
        private void lblTestGrade_Click(object sender, EventArgs e)
        {
